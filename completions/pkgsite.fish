...
complete -c pkgsite -n "__fish_pkgsite_using_subcommand help; and not __fish_seen_subcommand_from depends rdepends show search help" -f -a "depends" -d 'Query dependencies of packages'
complete -c pkgsite -n "__fish_pkgsite_using_subcommand help; and not __fish_seen_subcommand_from depends rdepends show search help" -f -a "rdepends" -d 'Query reverse dependencies of packages'
complete -c pkgsite -n "__fish_pkgsite_using_subcommand help; and not __fish_seen_subcommand_from depends rdepends show search help" -f -a "show" -d 'Get package information'
complete -c pkgsite -n "__fish_pkgsite_using_subcommand help; and not __fish_seen_subcommand_from depends rdepends show search help" -f -a "search" -d 'Search for packages'
complete -c pkgsite -n "__fish_pkgsite_using_subcommand help; and not __fish_seen_subcommand_from depends rdepends show search help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
